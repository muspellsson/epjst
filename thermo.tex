...
%\begin{tabular}{|l|l|l|}
%\hline\noalign{\smallskip}
%Process & Minimum dissipation conditions & Minimum entropy producion\\ \hline\noalign{\smallskip}
%Heat exchange for two flows $q = \alpha(T_2-T_1)$ & $\frac{T_1(f)}{T_2(f)} = 1 - \frac{\beta}{\alpha F}$ & \\ \hline\noalign{\smallskip}
%\end{tabular}
%\caption{Minimum dissipation conditions for thermodynamical processes}
%\label{tab2}
%\end{table}
